...
Fant_RedWocHammer = class()

local renderables = {
	"$SURVIVAL_DATA/Objects/00fant/weapons/Fant_RedWocHammer/Fant_RedWocHammer.rend"
}
...
Fant_RedWocHammer.Damage = 21
Fant_RedWocHammer.Range = 3.5
Fant_RedWocHammer.Speed = 1.5
Fant_RedWocHammer.SwingStaminaSpend = 4.5


Fant_RedWocHammer.swingCount = 2
Fant_RedWocHammer.mayaFrameDuration = 1.0/30.0
Fant_RedWocHammer.freezeDuration = 0.075

Fant_RedWocHammer.swings = { "sledgehammer_attack1", "sledgehammer_attack2" }
Fant_RedWocHammer.swingFrames = { 4.2 * Fant_RedWocHammer.mayaFrameDuration, 4.2 * Fant_RedWocHammer.mayaFrameDuration }
Fant_RedWocHammer.swingExits = { "sledgehammer_exit1", "sledgehammer_exit2" }

function Fant_RedWocHammer.client_onCreate( self )
	self.isLocal = self.tool:isLocal()
	self:init()
end

function Fant_RedWocHammer.client_onRefresh( self )
	self:init()
	self:loadAnimations()
end

function Fant_RedWocHammer.init( self )
...
function Fant_RedWocHammer.loadAnimations( self )
...
function Fant_RedWocHammer.client_onUpdate( self, dt )
...
function Fant_RedWocHammer.updateFreezeFrame( self, state, dt )
...
function Fant_RedWocHammer.server_startEvent( self, params )
...
function Fant_RedWocHammer.client_startLocalEvent( self, params )
	self:client_handleEvent( params )
end

function Fant_RedWocHammer.client_handleEvent( self, params )
...
--function Fant_RedWocHammer.sv_n_toggleTumble( self )
--	local character = self.tool:getOwner().character
--	character:setTumbling( not character:isTumbling() )
--end

function Fant_RedWocHammer.client_onEquippedUpdate( self, primaryState, secondaryState )
...
function Fant_RedWocHammer.client_onEquip( self )
...
function Fant_RedWocHammer.client_onUnequip( self )
...
function Fant_RedWocHammer.sv_updateBlocking( self, isBlocking )
...
function Fant_RedWocHammer.GetDamageData( self )
