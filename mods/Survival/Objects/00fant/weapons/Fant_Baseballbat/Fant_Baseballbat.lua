...
Fant_Baseballbat = class()

local renderables = {
	"$SURVIVAL_DATA/Objects/00fant/weapons/Fant_Baseballbat/Fant_Baseballbat.rend"
}
...
Fant_Baseballbat.Damage = 16
Fant_Baseballbat.Range = 3.0
Fant_Baseballbat.Speed = 1.35
Fant_Baseballbat.SwingStaminaSpend = 2


Fant_Baseballbat.swingCount = 2
Fant_Baseballbat.mayaFrameDuration = 1.0/30.0
Fant_Baseballbat.freezeDuration = 0.075

Fant_Baseballbat.swings = { "sledgehammer_attack1", "sledgehammer_attack2" }
Fant_Baseballbat.swingFrames = { 4.2 * Fant_Baseballbat.mayaFrameDuration, 4.2 * Fant_Baseballbat.mayaFrameDuration }
Fant_Baseballbat.swingExits = { "sledgehammer_exit1", "sledgehammer_exit2" }

function Fant_Baseballbat.client_onCreate( self )
	self.isLocal = self.tool:isLocal()
	self:init()
end

function Fant_Baseballbat.client_onRefresh( self )
	self:init()
	self:loadAnimations()
end

function Fant_Baseballbat.init( self )
...
function Fant_Baseballbat.loadAnimations( self )
...
function Fant_Baseballbat.client_onUpdate( self, dt )
...
function Fant_Baseballbat.updateFreezeFrame( self, state, dt )
...
function Fant_Baseballbat.server_startEvent( self, params )
...
function Fant_Baseballbat.client_startLocalEvent( self, params )
	self:client_handleEvent( params )
end

function Fant_Baseballbat.client_handleEvent( self, params )
...
--function Fant_Baseballbat.sv_n_toggleTumble( self )
--	local character = self.tool:getOwner().character
--	character:setTumbling( not character:isTumbling() )
--end

function Fant_Baseballbat.client_onEquippedUpdate( self, primaryState, secondaryState )
...
function Fant_Baseballbat.client_onEquip( self )
...
function Fant_Baseballbat.client_onUnequip( self )
...
function Fant_Baseballbat.sv_updateBlocking( self, isBlocking )
...
function Fant_Baseballbat.GetDamageData( self )
