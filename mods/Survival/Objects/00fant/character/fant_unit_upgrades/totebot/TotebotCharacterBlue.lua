...
TotebotCharacterBlue = class( Character )
...
function TotebotCharacterBlue.client_onCreate( self )
	self.cl = {}
	self.cl.animations = {}
...
function TotebotCharacterBlue.client_onDestroy( self )
	--print( "-- TotebotCharacter destroyed --" )
end

function TotebotCharacterBlue.client_onRefresh( self )
	--print( "-- TotebotCharacter refreshed --" )
end

function TotebotCharacterBlue.client_onGraphicsLoaded( self )
...
function TotebotCharacterBlue.client_onGraphicsUnloaded( self )
...
function TotebotCharacterBlue.cl_initGraphics( self )
...
function TotebotCharacterBlue.cl_initAnimationSwitch( self )
...
function TotebotCharacterBlue.client_onUpdate( self, deltaTime )
...
function TotebotCharacterBlue.client_onEvent( self, event )
	self:cl_handleEvent( event )
end

function TotebotCharacterBlue.cl_handleEvent( self, event )
...
function TotebotCharacterBlue.sv_n_updateTarget( self, params )
	self.network:sendToClients( "cl_n_updateTarget", params )
end

function TotebotCharacterBlue.cl_n_updateTarget( self, params )
	self.cl.target = params.target
end

function TotebotCharacterBlue.sv_e_unitDebugText( self, text )
	-- No sync cheat
