		...
		if params.eventName == "projectileHit" then
			if self.unit.character then
				...
				if distanceToProjectile <= 4.0 then
					if self.eventTarget == nil and params.attacker and params.attacker.character and sm.exists( params.attacker.character ) then
...
function TotebotGreenUnit.sv_takeDamage( self, damage, impact, hitPos, attacker )
...
function TotebotGreenUnit.sv_Totebothammerhit( self ) 
...
-- 00Fant
function TotebotGreenUnit.sv_takeDamage2( self, data )
