...
-- 00Fant
	FANT_GLOBAL_SV_cropAttackCells = nil
-- 00Fant
...
local Crops = {
	...
	-- 00Fant
	[tostring(hvs_growing_eggplant)] = 2.5, [tostring(hvs_mature_eggplant)] = 2.5
}
...
local Raiders = {
	...
	-- Raid level 3
	{
		{ [unit_totebot_green] = 3, [unit_haybot] = 2, [unit_totebot_blue] = 1 },
		{ [unit_totebot_green] = 4, [unit_haybot] = 2, [unit_heavy_haybot] = 1 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 4, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 1 },
	},
	-- Raid level 4
	{
		{ [unit_totebot_green] = 2, [unit_haybot] = 2, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 1 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 3, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 5, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 2 },
	},
	-- Raid level 5
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 2, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 3, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 3 },
		{ [unit_totebot_green] = 1, [unit_haybot] = 5, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 3 },
	},
	-- Raid level 6
	{
		{ [unit_haybot] = 1, [unit_totebot_blue] = 4, [unit_heavy_haybot] = 3 },
		{ [unit_totebot_green] = 1, [unit_haybot] = 4, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 4 },
		{ [unit_haybot] = 6, [unit_totebot_blue] = 4, [unit_heavy_haybot] = 4 },
	},
	-- Raid level 7
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 1, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 1, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 2, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 6 },
	},
	-- Raid level 8
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 2, [unit_totebot_red] = 1, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 2 , [unit_totebot_red] = 1, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 3, [unit_totebot_red] = 1, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 6 },
	},
	-- Raid level 9
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 3, [unit_totebot_red] = 1, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 3, [unit_totebot_red] = 2, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 4, [unit_farmbot] = 1, [unit_totebot_red] = 1, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 6 },
	},
	-- Raid level 10
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 4, [unit_farmbot] = 1, [unit_totebot_red] = 2, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 2 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 4, [unit_farmbot] = 1, [unit_totebot_red] = 2, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 5, [unit_farmbot] = 3, [unit_totebot_red] = 3, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 6 },
	}
	...
	-- Raid level 11
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 5, [unit_farmbot] = 2, [unit_totebot_red] = 3, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 5, [unit_farmbot] = 3, [unit_totebot_red] = 3, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 6 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 6, [unit_farmbot] = 4, [unit_totebot_red] = 3, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 8 },
	}
	,
	-- Raid level 12
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 5, [unit_farmbot] = 4, [unit_totebot_red] = 4, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 5, [unit_farmbot] = 5, [unit_totebot_red] = 4, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 6 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 6, [unit_farmbot] = 6, [unit_totebot_red] = 4, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 8 },
	}
	,
	-- Raid level 13
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 6, [unit_farmbot] = 6, [unit_totebot_red] = 5, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 6, [unit_farmbot] = 7, [unit_totebot_red] = 5, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 6 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 7, [unit_farmbot] = 8, [unit_totebot_red] = 5, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 8 },
	}
	,
	-- Raid level 14
	{
		{ [unit_totebot_green] = 1, [unit_haybot] = 6, [unit_tapebot] = 7, [unit_farmbot] = 8, [unit_totebot_red] = 6, [unit_totebot_blue] = 1, [unit_heavy_haybot] = 4 },
		{ [unit_totebot_green] = 2, [unit_haybot] = 8, [unit_tapebot] = 7, [unit_farmbot] = 9, [unit_totebot_red] = 6, [unit_totebot_blue] = 2, [unit_heavy_haybot] = 6 },
		{ [unit_totebot_green] = 3, [unit_haybot] = 10, [unit_tapebot] = 8, [unit_farmbot] = 10, [unit_totebot_red] = 6, [unit_totebot_blue] = 3, [unit_heavy_haybot] = 8 },
	}
}
...
local BotCapsules = {
	...
	-- 00Fant
	,
	sm.uuid.new( "da59ba03-e5fe-4940-aedf-55b72708e467" ),  -- Redtotebot
	sm.uuid.new( "2f09bad6-fe15-436b-a02e-196badddb714" ),  -- Bluetotebot
	sm.uuid.new( "c9524d17-a38b-42c2-ad27-de4726e0b917" )  -- unit_heavy_haybot
	-- 00Fant
}
local AnimalCapsules = {
	...
	-- 00Fant
	,
	sm.uuid.new( "eb783a31-3ec2-49c5-8a5f-5006da0e5d05" ),  -- Snail / Gary
...
function UnitManager.sv_onFixedUpdate( self )
	...
	-- 00Fant
	FANT_GLOBAL_SV_cropAttackCells = self.sv.cropAttackCells
	-- 00Fant
	...
	for _, cropAttackCell in pairs( self.sv.cropAttackCells ) do
		...
		if cropAttackCell.loaded and cropAttackCell.saved.attackTick and sm.game.getCurrentTick() >= cropAttackCell.saved.attackTick then
			...
			if isSurvival then
				...
				--sm.event.sendToWorld( sm.world.getCurrentWorld(), "sv_e_spawnRaiders", { attackPos = cropAttackCell.saved.attackPos, raiders = Raiders[cropAttackCell.saved.level][cropAttackCell.saved.wave], wave = cropAttackCell.saved.wave } )
				sm.event.sendToPlayer( sm.player.getAllPlayers()[1], "sv_e_spawnRaiders", { attackPos = cropAttackCell.saved.attackPos, raiders = Raiders[cropAttackCell.saved.level][cropAttackCell.saved.wave], wave = cropAttackCell.saved.wave } )
			end
			-- 00Fant
...
function UnitManager.sv_getRandomUnits( self, amount, position )
	...
	local unitWeights =
	{
		...
		-- 00Fant
		{ uuid = unit_totebot_red, chance = 0.1 },
		-- 00Fant
...
function UnitManager.sv_onInteractableCreated( self, interactable )
	...
	-- 00Fant
		if isAnyOf( interactable.shape.shapeUuid, { obj_powertools_sawblade, obj_powertools_drill, obj_powertools_fant_drill_small, obj_powertools_fant_drill, obj_powertools_fant_drill_large, obj_powertools_fant_autominer_farmbot_drill } ) then
	...
	for _,player in ipairs( self.newPlayers ) do
		...
		for _, cropAttackCell in pairs( self.sv.cropAttackCells ) do
			if cropAttackCell.saved.attackTick then
				...
				worldSelf.network:sendToClient( player, "cl_n_unitMsg", { fn = "cl_n_detected", tick = cropAttackCell.saved.attackTick, pos = cropAttackCell.saved.attackPos, level = cropAttackCell.saved.level } )
				-- 00Fant
			end
		end
	end
		...
		if self.sv.cropAttackCellScanCooldown:done() then
			...
			if #evaluatedCells > 0 then
				...
				if cropCount > 0 then
					...
					if highLevelCount >= 150 and cropValue >= 1000 then
						level = 14
					elseif highLevelCount >= 125 and cropValue >= 800 then
						level = 13
					elseif highLevelCount >= 100 and cropValue >= 600 then
						level = 12
					elseif highLevelCount >= 75 and cropValue >= 450 then
						level = 11
					-- 00Fant
...
function UnitManager.sv_beginRaidCountdown( self, worldSelf, position, level, wave, delay )
	...
	-- 00Fant
	if cropAttackCell == nil and not isSurvival then
		cropAttackCell = { x = x, y = y, loaded = true, saved = {} }
...
function UnitManager.cl_onWorldUpdate( self, worldSelf, deltaTime )
	removeFromArray( self.cl.attacks, function( attack )
		...
		attack.gui:setText( "Text", "#ff0000"..formatCountdown( timeLeft ) .. " - Lvl: " .. tostring( attack.level ) )
		-- 00Fant
...
function UnitManager.cl_n_detected( self, msg )
	...
	gui:setText( "Text", "#ff0000"..formatCountdown( ( msg.tick - sm.game.getServerTick() ) / 40 ) .. " - Lvl: " .. tostring( msg.level )  )
	
	-- 00Fant
	--self.cl.attacks[#self.cl.attacks + 1] = { gui = gui, tick = msg.tick }
	self.cl.attacks[#self.cl.attacks + 1] = { gui = gui, tick = msg.tick, level = msg.level }
end
