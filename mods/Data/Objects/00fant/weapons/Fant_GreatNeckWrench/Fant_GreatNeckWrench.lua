...
Fant_GreatNeckWrench = class()

local renderables = {
	"$SURVIVAL_DATA/Objects/00fant/weapons/Fant_GreatNeckWrench/Fant_GreatNeckWrench.rend"
}
...
Fant_GreatNeckWrench.Damage = 40
Fant_GreatNeckWrench.Range = 4.5
Fant_GreatNeckWrench.Speed = 0.65
Fant_GreatNeckWrench.SwingStaminaSpend = 17.5


Fant_GreatNeckWrench.swingCount = 2
Fant_GreatNeckWrench.mayaFrameDuration = 1.0/30.0
Fant_GreatNeckWrench.freezeDuration = 0.075

Fant_GreatNeckWrench.swings = { "sledgehammer_attack1", "sledgehammer_attack2" }
Fant_GreatNeckWrench.swingFrames = { 4.2 * Fant_GreatNeckWrench.mayaFrameDuration, 4.2 * Fant_GreatNeckWrench.mayaFrameDuration }
Fant_GreatNeckWrench.swingExits = { "sledgehammer_exit1", "sledgehammer_exit2" }

function Fant_GreatNeckWrench.client_onCreate( self )
	self.isLocal = self.tool:isLocal()
	self:init()
end

function Fant_GreatNeckWrench.client_onRefresh( self )
	self:init()
	self:loadAnimations()
end

function Fant_GreatNeckWrench.init( self )
...
function Fant_GreatNeckWrench.loadAnimations( self )
...
function Fant_GreatNeckWrench.client_onUpdate( self, dt )
...
function Fant_GreatNeckWrench.updateFreezeFrame( self, state, dt )
...
function Fant_GreatNeckWrench.server_startEvent( self, params )
...
function Fant_GreatNeckWrench.client_startLocalEvent( self, params )
	self:client_handleEvent( params )
end

function Fant_GreatNeckWrench.client_handleEvent( self, params )
...
--function Fant_GreatNeckWrench.sv_n_toggleTumble( self )
--	local character = self.tool:getOwner().character
--	character:setTumbling( not character:isTumbling() )
--end

function Fant_GreatNeckWrench.client_onEquippedUpdate( self, primaryState, secondaryState )
...
function Fant_GreatNeckWrench.client_onEquip( self )
...
function Fant_GreatNeckWrench.client_onUnequip( self )
...
function Fant_GreatNeckWrench.sv_updateBlocking( self, isBlocking )
...
function Fant_GreatNeckWrench.GetDamageData( self )
